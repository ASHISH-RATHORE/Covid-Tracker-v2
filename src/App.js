...
import Slots from './Vaccine-Slots/Slots';
import IndiaDetails from './IndiaComponent/IndiaDetails';
import ProtectedRoute from './Vaccine-booking/Protected Route/ProtectedRoute'
import World from './WorldComponent/World'
import Download from './Vaccine-booking/Component/Download';
  ...
  return (
    <div>
            ...
            <Switch>
                  ...
                  <Route path='/indiadetails' exact component={IndiaDetails}/>
